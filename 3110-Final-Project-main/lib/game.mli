...
module type my_game = sig
  ...
  (** [initialize_game game_type board_size] creates and returns the starting
      board for a game. [game_type] is 0 for 2048, 1 or 1024, or 2 for 65536.
      [board_size] is the size of the game board (4 for 2048 and 1024, 5 for
      65536). *)
